...
class validation_curves:
    ...
    def run(self, X_train, X_test, y_train, y_test, clf_type, sc1_type, params_dict, dataset, learner_name, complexity_name):
...
if __name__ == "__main__":
    ...
    vc.run(X_train_titanic, X_test_titanic, y_train_titanic, y_test_titanic, KNeighborsClassifier, StandardScaler, params_dict, 'titanic', 'KNN', '')
    vc.run(X_train_wine, X_test_wine, y_train_wine, y_test_wine, KNeighborsClassifier, StandardScaler, params_dict, 'wine', 'KNN', '')
    ...
    vc.run(X_train_titanic, X_test_titanic, y_train_titanic, y_test_titanic, DecisionTreeClassifier, None, params_dict, 'titanic', 'Tree', 'Tree nodes')
    vc.run(X_train_wine, X_test_wine, y_train_wine, y_test_wine, DecisionTreeClassifier, None, params_dict, 'wine', 'Tree', 'Tree nodes')
